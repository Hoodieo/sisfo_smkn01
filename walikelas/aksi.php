...
//UPDATE CATATAN AKADEMIK SISWA
elseif ($mod=='edit_catatan') {
	$id = $_GET['id'];
	$catatan = $_POST['catatan'];

	$db->query("UPDATE tbl_siswa SET keterangan='$catatan' WHERE nis=$id");
	echo "<script>alert('Catatan akademik berhasil diedit')</script>";
	redirect_js("index?m=nilai_siswa&id=$id");
}
